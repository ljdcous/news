...
var c=document.createElement('style');c.type='text/css';c.innerText=cssText;document.head.appendChild(c);}}
	...
	$("#i74ed0a0493130026>div>div").each(function(){
		i=$(this).index();
		var img_src=$(this).find(".p1727m839390960b0b1328").html();

		$("#fp-nav>ul>li").eq(i).find("span").append(img_src);
	})


window.myScreenLeave = function(index, nextIndex, direction) {
	console.log(nextIndex-1);
	$("#fp-nav>ul>li").eq(nextIndex-1).addClass("on").siblings().removeClass("on");
}
...
animation.config['an645']={"id":"645","clientIndex":"dcbb21a448c33a2e","timingFunction":"","duration":"1.7","delay":"0","type":1,"name":"645_产品2_向左飞入","anName":"an_tran_645","library":"fadeInRight","device":1,"loop":1,"resume":1,"clear":1};
