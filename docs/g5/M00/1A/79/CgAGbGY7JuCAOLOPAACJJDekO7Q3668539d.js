...
var ptnk = util.queryString("ptnk");
if(ptnk!=null){
	setTimeout(function(){
		$(".p1777m022e6ec82a4ef973").trigger("click");
	},500);
}
...
$.getScript("Js/jquery.mCustomScrollbar.concat.min.js", function () {
	...
	//PC设备
	//运营商整体特殊滚动条
	$("#i30e274ac0140549a .xg_list").each(function (i) {
	...
	//运营商左侧特殊滚动条
	$("#ia248b31827f6a67a .xg_tab_l_t").each(function (i) {
		$(this).mCustomScrollbar({
			scrollButtons: {
				enable: true
			},
	...
	//轻量级5G 核心网特殊滚动条
	$("#ic842bb69cceb1f15 .xg_rdata").each(function (i) {
		$(this).mCustomScrollbar({
			scrollButtons: {
				enable: true
			},
	...
	//专网	
	$("#ieee90ea569824f26 .xg_tab_tt .xg_tab_l_t").each(function (i) {
		$(this).mCustomScrollbar({
			scrollButtons: {
				enable: true
			},
	...
	$("#ieee90ea569824f26 .xg_list").each(function (i) {
		$(this).mCustomScrollbar({
			scrollButtons: {
				enable: true
			},
...
$(function(){tab.init('ieee90ea569824f26');var getcount = 20; var getindex = setInterval(function () { var tabselectdefault = $('#ieee90ea569824f26 .xg_tab_tl-select');if (getcount-- <= 0 || $(tabselectdefault).length<=0) { clearInterval(getindex); return; } tab.changeitem(tabselectdefault) }, 300);});
