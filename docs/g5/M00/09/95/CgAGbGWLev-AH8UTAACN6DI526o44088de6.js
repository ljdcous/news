...
if (device == 1) {
	//PC设备
	$(".p1822mc1a9faa9aa6cc904").parent().css({
		"min-height": "1100px",
		"max-height": "1100px"
	});

	$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=319&language=zh-cn");
	$("#ic81aff0f95f36b8a").click(function() {
		$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=319&language=zh-cn");
		$(".p1822mc1a9faa9aa6cc904").parent().css({
			"min-height": "1100px",
			"max-height": "1100px"
	...
	$("#i5cd9c1e07c6abb5d").click(function() {
		$(".p1822mc1a9faa9aa6cc904").parent().css({
			"min-height": "670px",
			"max-height": "670px"
		});
		$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=320&language=zh-cn");
	})
	$("#i1090452e1f37ea05").click(function() {
		$(".p1822mc1a9faa9aa6cc904").parent().css({
			"min-height": "670px",
			"max-height": "670px"
		});
		$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=321&language=zh-cn");
	})
	$("#if51b630758072525").click(function() {
		$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=985&language=zh-cn");
		$(".p1822mc1a9faa9aa6cc904").parent().css({
			"min-height": "1100px",
			"max-height": "1100px"
		});
	})
	$("#i3f235aac608b7382").click(function() {
		$(".p1822mc1a9faa9aa6cc904 iframe").attr("src", "https://open.sseinfo.com/ir2/?id=322&language=zh-cn");
		$(".p1822mc1a9faa9aa6cc904").parent().css({
			"min-height": "500px",
			"max-height": "500px"
		});
	})	
	$("#ic81aff0f95f36b8a").mouseover(function() {
		$(this).css("cursor", "pointer")
	})
	$("#i5cd9c1e07c6abb5d").mouseover(function() {
		$(this).css("cursor", "pointer")
	})
	$("#i1090452e1f37ea05").mouseover(function() {
		$(this).css("cursor", "pointer")
	})

	$("#if51b630758072525").mouseover(function() {
		$(this).css("cursor", "pointer")
	})
	$("#i3f235aac608b7382").mouseover(function() {
		$(this).css("cursor", "pointer")
	})
} else if (device == 2) {
	//手机设备
