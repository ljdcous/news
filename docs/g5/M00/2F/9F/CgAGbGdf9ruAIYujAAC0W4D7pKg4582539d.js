...
var config698c66c06af2f48a={"autoPlay":"false","pc_slidesToShow":"1","pc_slidesToScroll":"1","arrows":"false","m_slidesToShow":"2","m_slidesToScroll":"2","dots":"false","m_arrows":"false","row":"1","slidesPerRow":"1","m_row":"1","m_slidesPerRow":"2","speed":"1000","infinite":"true","pc_mouseTouch":"false","centerMode":"false","centerPadding":"150px","m_centerPadding":"80px","onBeforeChange":" ","onAfterChange":" ","pauseOnHover":"true"};(function(root,config){var container = root.find(".xg_list:first");
...
$(main);})($('#c698c66c06af2f48a'),config698c66c06af2f48a);
//头部加黑色背景
...
//客户案例轮播效果
     var device = page.currentDevice();
        if (device == 1) {
 //PC设备
 $("#i7bb928af5ae8af5f").addClass("swiper-container");
$("#i7bb928af5ae8af5f>div").addClass("swiper-wrapper");
$("#i7bb928af5ae8af5f>div>div").addClass("swiper-slide");
// $("#i7bb928af5ae8af5f").append('<div class="swiper-button-prev"></div><div class="swiper-button-next"></div>');
$("#ie1c445df76d09517").addClass("swiper-container2");
$("#ie1c445df76d09517>div").addClass("swiper-wrapper");
$("#ie1c445df76d09517>div>div").addClass("swiper-slide");
$("#ie1c445df76d09517").append('<div class="swiper-button-prev1"></div><div class="swiper-button-next1"></div>');
$("#ie1c445df76d09517").after('<span class="swiper-pagination"></span>');
...
$("#i8e1ae925b9693c3c").children(".data_row").children(".data_col").css("width","100%");

var srcs = $("#i8550adb56118db14 video").attr("src");
if(srcs==""){
	$("#i8550adb56118db14 video").removeAttr("controls")
}
$("#i8550adb56118db14 .xg_video_button").remove();
...
$(function(){h5video.init($('#i8550adb56118db14'));});
