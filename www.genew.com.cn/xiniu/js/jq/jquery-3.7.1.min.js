...
$.fn.click=function(fun){if(!fun)return $(this).trigger("click");$(this).on("click",fun);return $(this);}
...
$.fn.error=function(fun){$(this).on("error",fun);return $(this);}
$.fn.resize=function(fun){if(!fun)return $(this).trigger("resize");$(this).on("resize",fun);return $(this);}
