...
var config095adc7038ced503={"autoPlay":"false","pc_slidesToShow":"1","pc_slidesToScroll":"1","arrows":"false","m_slidesToShow":"2","m_slidesToScroll":"2","dots":"false","m_arrows":"false","row":"1","slidesPerRow":"1","m_row":"1","m_slidesPerRow":"2","speed":"1000","infinite":"true","pc_mouseTouch":"false","centerMode":"false","centerPadding":"150px","m_centerPadding":"80px","onBeforeChange":" ","onAfterChange":" ","pauseOnHover":"true"};(function(root,config){var container = root.find(".xg_list:first");
...
$(main);})($('#c095adc7038ced503'),config095adc7038ced503);
//头部加黑色背景
$("#sf1721-00001").css({"background":"#111"})
...
// $("#i7bb928af5ae8af5f").append('<div class="swiper-button-prev"></div><div class="swiper-button-next"></div>');
$("#i1a3305ff3912edb9").addClass("swiper-container2");
$("#i1a3305ff3912edb9>div").addClass("swiper-wrapper");
$("#i1a3305ff3912edb9>div>div").addClass("swiper-slide");
$("#i1a3305ff3912edb9").append('<div class="swiper-button-prev1"></div><div class="swiper-button-next1"></div>');
$("#i1a3305ff3912edb9").after('<span class="swiper-pagination"></span>');
    ...
    on: {
        progress: function(progress) {
            for (i = 0; i < this.slides.length; i++) {
                ...
                console.log("slideProgress:"+slideProgress+",slide:"+slide+",modify((Math.abs(slideProgress) - 1) * 0.35 + 1):"+modify);
                translate = slideProgress * modify * 250 + 'px';
                console.log("translate(slideProgress * modify * 250 + 'px'):"+translate);
                scale = 1 - Math.abs(slideProgress) / 7;
          console.log("scale(1 - Math.abs(slideProgress) / 7):"+scale);
...
var srcs = $("#ifdef2d3f7443bb64 video").attr("src");
if(srcs==""){
  $("#ifdef2d3f7443bb64 video").removeAttr("controls")
}
$("#ifdef2d3f7443bb64 .xg_video_button").remove();
...
banner.init($('#i813ac924ad148a4f'));
$(function(){tMenu.m3($('#i11fc1047ca204189'))});
$(function(){h5video.init($('#ifdef2d3f7443bb64'));});
