...
function judgeevent() {
	...
	$(".p1778m4889de9d15d70249 ul").on("click", ".xg_pnNumber", function() {
		...
		var element = $(this).parents(".p1778m4889de9d15d70249").siblings("#i13f1613b27cb2660").children(".data_row");
		var dtype = $(this).parent().parent().prev().attr("data-dtype");
		//console.log(typeid);
		//console.log(element);
		$(this).siblings().removeClass("xg_pnNumber-select");
		$(this).addClass("xg_pnNumber-select");
		ajxarequest(typeid, element,pageIndex,dtype);
		return false;
	})
}


function ajxarequest(typeid, element,pageIndex,dtype) {
	var param = {
		number: 293293,
		methodKey: 1,
		typeid: typeid,
		...
		if (result.code == 200) {
			if (result.data != null) {
				...
				$.each(result.data, function(index, obj) {
					...
					<img data-src="" alt="' + obj.name + '" title="' + obj.name + '" src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==">\
					</div>\
...
$(function(){morebtn.init($('#i86a65a9aedffccf3').children('input[type=button]'));});
$(function(){morebtn.init($('#i73665e88bd63c221').children('input[type=button]'));});
$(function(){morebtn.init($('#i36cd7ca6e5033181').children('input[type=button]'));});
$(function(){morebtn.init($('#i86a65a9aedffccf3').children('input[type=button]'));});
$(function(){morebtn.init($('#i33da074015167be1').children('input[type=button]'));});
$(function(){morebtn.init($('#ibf789a57f83f009f').children('input[type=button]'));});
$(function(){morebtn.init($('#i33da074015167be1').children('input[type=button]'));});
