...
$(function(){tab.init('if8bd21927b31375e');var getcount = 20; var getindex = setInterval(function () { var tabselectdefault = $('#if8bd21927b31375e .xg_tab_tl-select');if (getcount-- <= 0 || $(tabselectdefault).length<=0) { clearInterval(getindex); return; } tab.changeitem(tabselectdefault) }, 300);});
