...
;(function(root){var id = root.attr("id");
var css = '<style type="text/css">';
var device = page.currentDevice();

//PC样式
css += '@media only screen and (min-width: 769px){';
css+= '#' + id + ' .swiper-pagination{display:none;}';
css+= '#' + id + ' {position:relative;width:1280px;margin:0 auto}';
css+= '#' + id + ' .swiper-container {padding-bottom:60px;}';
css+= '#' + id + ' .swiper-slide {width:460px;height:370px;}';
css+= '#' + id + ' .swiper-slide .text {position:absolute;left:15%;top:20%;width:90%;margin:0 auto;clear:both;overflow:hidden;}';
css+= '#' + id + ' .swiper-slide .text img {float:left;width:120px;height:120px;margin-right:15px;border:2px solid #ededed;}';
css+= '#' + id + ' .swiper-slide h2 {float:left;padding-top:0;text-align:center;font-size:20px;margin-bottom:10px;}';
css+= '#' + id + ' .swiper-slide h4 {float:left;margin:0;width:60%;font-size:16px;}';
css+= '#' + id + ' .swiper-pagination {width:100%;bottom:20px;}';
css+= '#' + id + ' .swiper-pagination-bullets .swiper-pagination-bullet {margin:0 5px;border:1px solid #d5d5d5;background-color:#fff;width:10px;height:10px;opacity:1;}';
css+= '#' + id + ' .swiper-pagination-bullets .swiper-pagination-bullet-active {border:1px solid #06418f;background-color:#06418f;}';
css+= '#' + id + ' .swiper-button-prev {width: 50px;height: 50px; background-size: 100% 100% !important; background: url("https://0.rc.xiniu.com/g3/M00/2F/7A/CgAH6F5ksvmAQ8BFAAAFSV0KbuI521.png") no-repeat; }';
css+= '#' + id + ' .swiper-button-next {width: 50px;height: 50px; background-size: 100% 100% !important; background: url("https://0.rc.xiniu.com/g3/M00/2F/7A/CgAH6F5ks4-ALZqYAAAFLH30mrU531.png") no-repeat;}';
css+= '#' + id + ' .swiper-button-prev:after,.swiper-button-next:after{display: none;}';

//手机样式
css+= '}@media only screen and (max-width:768px) {';
css+= '#' + id + ' .swiper-pagination {width:100%;bottom:20px;display: none;}';
css+= '#' + id + ' .swiper-pagination-bullets .swiper-pagination-bullet {margin:0 5px;border:1px solid #d5d5d5;background-color:#fff;width:10px;height:10px;opacity:1;}';
css+= '#' + id + ' .swiper-pagination-bullets .swiper-pagination-bullet-active {border:1px solid #06418f;background-color:#06418f;}';
css+= '#' + id + ' .swiper-button-prev {width: 50px;height: 50px; background-size: 100% 100% !important; background: url("https://0.rc.xiniu.com/g3/M00/2F/7A/CgAH6F5ksvmAQ8BFAAAFSV0KbuI521.png") no-repeat; }';
css+= '#' + id + ' .swiper-button-next {width: 50px;height: 50px; background-size: 100% 100% !important; background: url("https://0.rc.xiniu.com/g3/M00/2F/7A/CgAH6F5ks4-ALZqYAAAFLH30mrU531.png") no-repeat;}';
css+= '#' + id + ' .swiper-button-prev:after,.swiper-button-next:after{display: none;}';
css+= '#' + id + ' .swiper-slide {width:85%;}';
css+= '#' + id + ' .swiper-slide-thumb-active span{color: #b90208 !important;font-weight: bold;}';

css+= '#' + id + ' .swiper-slide-thumb-active #i443a89d85d3de8e4{background-image: url(https://0.rc.xiniu.com/g3/M00/31/56/CgAH515pokKAXaIjAAADa5ftebQ352.png) !important;}';

css+= '}</style>';
$(document.body).append(css);

root.find(".swiper-slide").find(".xg_img").css({"width":"auto","height":"auto"});

var datas = root.find(".xg_list:first");
datas.addClass("swiper-container");
datas.children("div").addClass('swiper-wrapper');
datas.children().children('div').addClass('swiper-slide');
datas.append('<div class="swiper-pagination"></div>');
datas.after('<div class="swiper-button-prev"></div><div class="swiper-button-next"></div>');
root.find(".swiper-slide").find(".xg_img").css({"width":"auto","height":"auto"});

new Swiper("#" + root.attr("id") + ' .swiper-container', {
...
if (device == 2) {
	setTimeout(function(){
		$("#if17210d46af989fd47cef0").children(".xg_menuMobile").children(".xg_menuPanel").children(".xg_menuUl").children(".xg_menuLi1:eq(6)").addClass("xg_menuLi1-select").siblings().removeClass("xg_menuLi1-select");
	},500);
}
...
$(function(){tab.init('ia778e0ff8482caa2');var getcount = 20; var getindex = setInterval(function () { var tabselectdefault = $('#ia778e0ff8482caa2 .xg_tab_tl-select');if (getcount-- <= 0 || $(tabselectdefault).length<=0) { clearInterval(getindex); return; } tab.changeitem(tabselectdefault) }, 300);});
